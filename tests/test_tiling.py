...
from geovibes.tiling import (
    MGRSTileId,
    MGRSTileGrid,
    get_crs_from_mgrs_tile_id,
...
@pytest.mark.parametrize(
    "mgrs_id,expected_utm_zone,expected_latitude_band,expected_grid_square",
    [
        ("18SJH", 18, "S", "JH"),
        ("32NEA", 32, "N", "EA"),
        ("1AAB", 1, "A", "AB"),
...
def test_mgrs_tile_id_from_str_valid(
    mgrs_id, expected_utm_zone, expected_latitude_band, expected_grid_square
):
...
@pytest.mark.parametrize(
    "utm_zone,latitude_band,grid_square,expected_str",
    [
        (18, "S", "JH", "18SJH"),
        (32, "N", "EA", "32NEA"),
        (1, "A", "AB", "1AAB"),
...
def test_mgrs_tile_id_creation_and_str(
    utm_zone, latitude_band, grid_square, expected_str
):
