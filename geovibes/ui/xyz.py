...
def get_map_image(
    ...
    if tile_spec and tile_spec.get("tile_size_px") and tile_spec.get("meters_per_pixel"):
        try:
            ...
            with Image.open(BytesIO(image_bytes)) as img:
                ...
                enlarged = img.resize((new_width, new_height), Image.BILINEAR)
                left = (new_width - width) // 2
                top = (new_height - height) // 2
                cropped = enlarged.crop((left, top, left + width, top + height))
